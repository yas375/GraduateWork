...
describe(@"SaatiRankAreaView", ^{
  context(@"with height 170 and maximum rank 9", ^{
    ...
    it(@"returns correct fractions for Y values", ^{
      [[[rankArea fractionForY:0] should] equal:[Fraction fractionWithNumerator:1 denominator:9]];
      [[[rankArea fractionForY:5] should] equal:[Fraction fractionWithNumerator:1 denominator:9]];
      [[[rankArea fractionForY:10] should] equal:[Fraction fractionWithNumerator:1 denominator:8]];
      [[[rankArea fractionForY:20] should] equal:[Fraction fractionWithNumerator:1 denominator:7]];
      [[[rankArea fractionForY:53] should] equal:[Fraction fractionWithNumerator:1 denominator:4]];
      [[[rankArea fractionForY:77] should] equal:[Fraction fractionWithNumerator:1 denominator:2]];
      ...
      [[[rankArea fractionForY:90] should] equal:[Fraction fractionWithNumerator:2]];
      [[[rankArea fractionForY:120] should] equal:[Fraction fractionWithNumerator:5]];
      [[[rankArea fractionForY:137] should] equal:[Fraction fractionWithNumerator:6]];
      [[[rankArea fractionForY:160] should] equal:[Fraction fractionWithNumerator:9]];
      [[[rankArea fractionForY:163] should] equal:[Fraction fractionWithNumerator:9]];
      [[[rankArea fractionForY:170] should] equal:[Fraction fractionWithNumerator:9]];
    });

    it(@"returns correct Y values for fractions", ^{
      [[theValue([rankArea yForFraction:[Fraction fractionWithNumerator:1 denominator:9]]) should] equal:5 withDelta:0.01];
      [[theValue([rankArea yForFraction:[Fraction fractionWithNumerator:1 denominator:4]]) should] equal:55 withDelta:0.01];
      [[theValue([rankArea yForFraction:[Fraction fractionWithNumerator:1]]) should] equal:85 withDelta:0.01];
      [[theValue([rankArea yForFraction:[Fraction fractionWithNumerator:3]]) should] equal:105 withDelta:0.01];
      [[theValue([rankArea yForFraction:[Fraction fractionWithNumerator:9]]) should] equal:165 withDelta:0.01];
    });
